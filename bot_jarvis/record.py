...
class Record:
    ...
    def change_phone(self, new_phone) -> str:
        ...
        if self.phones:
            ...
            while True:
                ...
                try:
                    ...
                    if choosing > 0:
                        ...
                        return color_message(f"Phone '{showing[choosing]}' of '{self.name.value.title()}' changed to '{new_phone.value}'.", "green")
                    else:
                        raise KeyError
            ...
            raise ValueError(color_message(f"Phone list of '{self.name.value.title()}' is empty"), "red")
    ...
    def delete_phone(self) -> str:
        ...
        if self.phones:
            ...
            while True:
                ...
                try:
                    ...
                    if choosing > 0:
                        ...
                        return color_message(f"Phone '{showing[choosing]}' of '{self.name.value.title()}' removed.", "green")
                    else:
                        raise KeyError
            ...
            raise ValueError(color_message(f"Phones list of '{self.name.value.title()}' is empty."), "red")

    def add_mail(self, mail) -> str:
        '''Add an email to the contact.'''
        added_email = Email(mail)
        self.emails.append(added_email)
        return color_message(f"The email '{added_email.value}' was added to '{self.name.value.title()}'.", "green")
    ...
    def change_mail(self, new_mail) -> str:
        ...
        if self.emails:
            ...
            while True:
                ...
                try:
                    ...
                    if choosing > 0:
                        ...
                        return color_message(f"Email < {showing[choosing]} > of < {self.name.value.title()} > changed to the < {new_mail.value} >", "green")
                    else:
                        raise KeyError
            ...
            raise ValueError(color_message(f"Emails list of '{self.name.value.title()}' is empty."), "red")
            ...
            while True:
                ...
                try:
                    ...
                    if choosing > 0:
                        ...
                        return color_message(f"Email '{showing[choosing]}' of '{self.name.value.title()}' removed.", "green")
                    else:
                        raise KeyError
    ...
    def change_note(self, list_new_note) -> str:
        ...
        return color_message(f"The note '{new_note[:-1]}' was added to the contact '{self.name.value.title()}'.", "green")

    def delete_note(self) -> str:
        '''Deletes the note.'''
        deleted_note = self.note.value
        self.note = None
        return color_message(f"The note '{deleted_note}' of contact '{self.name.value}' was deleted.", "green")
    ...
    def change_tag(self, new_tag_list):
        ...
        if self.tag:
            ...
            return color_message(f"The new tag {new_tag_list} has been added to old one {old_tag.value}.", "green")

    def delete_tags(self) -> str:
        '''Deletes all tags.'''
        deleted_tag = self.tag
        self.tag = None
        return color_message(f"The tag '{deleted_tag.value}' of contact '{self.name.value}' was deleted.", "green")
        ...
        if self.tag:
            ...
            while True:
                try:
                    ...
                    print(f"{message} {showing}")
                    choosing = input(color_message("Choose № of this tags >>> ", "purple"))
    ...
    def delete_birthday(self):
        '''Deletes a birthday.'''
        self.birthday = None
        return color_message(f"The birhdays was deleted successfully.", "green")